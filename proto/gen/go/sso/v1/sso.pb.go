...
func (x *RegisterResquest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterResquest) ProtoMessage() {}

func (x *RegisterResquest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_sso_sso_proto_msgTypes[0]
...
// Deprecated: Use RegisterResquest.ProtoReflect.Descriptor instead.
func (*RegisterResquest) Descriptor() ([]byte, []int) {
	return file_proto_sso_sso_proto_rawDescGZIP(), []int{0}
}

func (x *RegisterResquest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *RegisterResquest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_proto_sso_sso_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x44, 0x0a, 0x10, 0x52,
	0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x72, 0x22, 0x29,
	...
	0x69, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x32, 0xac, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68,
	0x12, 0x3a, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x16, 0x2e, 0x61,
	0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x71,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0e, 0x5a, 0x0c, 0x73, 0x73, 0x6f, 0x2f, 0x76, 0x31,
...
var file_proto_sso_sso_proto_goTypes = []interface{}{
	(*RegisterResquest)(nil), // 0: auth.RegisterResquest
...
var file_proto_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterResquest
